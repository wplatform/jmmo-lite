...
public interface BNetAccountRepository extends CrudRepository<BNetAccount, Long> {
    ...
    List<BattlenetAccountToy> findAccountToys(@Param("accountId") int accountId);

    // 查询账号坐骑
    @Query("SELECT mountSpellId, flags FROM battlenet_account_mounts WHERE battlenetAccountId = :battlenetAccountId")
    List<BattlenetAccountMount> findAccountMounts(@Param("battlenetAccountId") int battlenetAccountId);
    ...
    List<BattlenetItemAppearance> findItemAppearances(@Param("battlenetAccountId") int battlenetAccountId);
    ...
    List<BattlenetAccountHeirloom> findAccountHeirlooms(@Param("accountId") int accountId);
    ...
    List<BattlenetItemFavoriteAppearance> selectFavoriteItemAppearances(@Param("battlenetAccountId") int battlenetAccountId);
