...
public interface UpdateFieldFlags {

    short UF_FLAG_NONE                = 0x000;
    short UF_FLAG_PUBLIC              = 0x001;
    short UF_FLAG_PRIVATE             = 0x002;
    short UF_FLAG_OWNER               = 0x004;
    short UF_FLAG_ITEM_OWNER          = 0x008;
    short UF_FLAG_SPECIAL_INFO        = 0x010;
    short UF_FLAG_PARTY_MEMBER        = 0x020;
    short UF_FLAG_UNIT_ALL            = 0x040;
    short UF_FLAG_DYNAMIC             = 0x080;
    short UF_FLAG_0x100               = 0x100;
    short UF_FLAG_URGENT              = 0x200;
    short UF_FLAG_URGENT_SELF_ONLY    = 0x400;

    //int[] ItemUpdateFieldFlags = new int[CONTAINER_END];
    //int[] ItemDynamicUpdateFieldFlags = new int[CONTAINER_DYNAMIC_END];
    //int[] UnitUpdateFieldFlags = new int[PLAYER_END];
    //int[] UnitDynamicUpdateFieldFlags = new int[PLAYER_DYNAMIC_END];
    //int[] GameObjectUpdateFieldFlags = new int[GAME_OBJECT_END];
    //int[] GameObjectDynamicUpdateFieldFlags = new int[GAME_OBJECT_DYNAMIC_END];
    //int[] DynamicObjectUpdateFieldFlags = new int[DYNAMIC_OBJECT_END];
    //int[] CorpseUpdateFieldFlags = new int[CORPSE_END];
    //int[] AreaTriggerUpdateFieldFlags = new int[AREA_TRIGGER_END];
    //int[] SceneObjectUpdateFieldFlags = new int[SCENE_OBJECT_END];
    //int[] ConversationUpdateFieldFlags = new int[CONVERSATION_END];
    //int[] ConversationDynamicUpdateFieldFlags = new int[CONVERSATION_DYNAMIC_END];


    int[] ITEM_UPDATE_FIELD_FLAGS = {
    ...
    int[] ITEM_DYNAMIC_UPDATE_FIELD_FLAGS = {
    ...
    int[] UNIT_DYNAMIC_UPDATE_FIELD_FLAGS = {
    ...
    int[] GAME_OBJECT_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+1
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+2
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+3
    ...
    int[] GAME_OBJECT_DYNAMIC_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // GAMEOBJECT_DYNAMIC_ENABLE_DOODAD_SETS
    };

    int[] DYNAMIC_OBJECT_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+1
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+2
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+3
    ...
    int[] AREA_TRIGGER_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+1
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+2
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+3
    ...
    int[] SCENE_OBJECT_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+1
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+2
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+3
    ...
    int[] CONVERSATION_UPDATE_FIELD_FLAGS = {
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+1
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+2
            UF_FLAG_PUBLIC,                                         // OBJECT_FIELD_GUID+3
    ...
    int[] CONVERSATION_DYNAMIC_UPDATE_FIELD_FLAGS = {
