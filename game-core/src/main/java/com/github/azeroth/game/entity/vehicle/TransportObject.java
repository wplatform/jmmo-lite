...
public interface TransportObject {
    static void updatePassengerPosition(TransportObject transport, Map map, WorldObject passenger, Position pos, boolean setHomePosition) {
    ...
    TransportObject removePassenger(WorldObject passenger);
