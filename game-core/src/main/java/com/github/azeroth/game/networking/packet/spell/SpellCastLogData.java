...
public class SpellCastLogData {
    ...
    public final void initialize(Unit unit) {
        ...
        attackPower = unit.getTotalAttackPowerValue(unit.getUnitClass() == UnitClass.Hunter ? WeaponAttackType.RangedAttack : WeaponAttackType.BASE_ATTACK);
    ...
    public final void initialize(Spell spell) {
        ...
        if (unitCaster != null) {
            ...
            attackPower = unitCaster.getTotalAttackPowerValue(unitCaster.getUnitClass() == UnitClass.Hunter ? WeaponAttackType.RangedAttack : WeaponAttackType.BASE_ATTACK);
