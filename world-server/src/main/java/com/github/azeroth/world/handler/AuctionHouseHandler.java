...
public class AuctionHouseHandler {
    ...
    game.AuctionManager sAuctionMgr;

    void HandleAuctionBrowseQuery(WorldRequest request, WorldResponse response)
    {
        AuctionBrowseQuery browseQuery = request.receiveObject(AuctionBrowseQuery.class);
    ...
    void HandleAuctionGetCommodityQuote(WorldPackets::AuctionHouse::AuctionGetCommodityQuote& getCommodityQuote)
    {
    ...
    void SendAuctionCommandResult(uint32 auctionId, AuctionCommand command, AuctionResult errorCode, Milliseconds delayForNextAction, InventoryResult bagResult /*= 0*/)
    {
