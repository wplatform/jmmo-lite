...
public class ItemHandler {
    ...
    void SendListInventory(ObjectGuid vendorGuid)
    {
    ...
    void HandleItemRefund(WorldPackets::Item::ItemPurchaseRefund& packet)
    {
        ...
        if (!item)
        {
            TC_LOG_DEBUG("network", "HandleItemRefund: Item ({}) not found!", packet.ItemGUID.ToString());
            return;
        }
    ...
    bool CanUseBank(ObjectGuid bankerGUID) const
    {
    ...
    void HandleUseCritterItem(WorldPackets::Item::UseCritterItem& useCritterItem)
    {
    ...
    void HandleRemoveNewItem(WorldPackets::Item::RemoveNewItem& removeNewItem)
    {
        ...
        if (!item)
        {
            TC_LOG_DEBUG("network", "HandleRemoveNewItem: Item ({}) not found for {}!", removeNewItem.ItemGuid.ToString(), GetPlayerInfo());
            return;
        }
    ...
    void HandleReforgeItem(WorldPackets::Item::ReforgeItem& reforgeItem)
    {
        ...
        {
            TC_LOG_DEBUG("network", "HandleReforgeItem - Reforger {} not found or player can't interact with it (missing UNIT_NPC_FLAG_2_REFORGER)!", reforgeItem.ReforgerGUID.ToString());
            return;
        }
        ...
        if (!item)
        {
            TC_LOG_DEBUG("network", "HandleReforgeItem: {} tried to reforge a non-existing item! Possible cheater or malformed packet.", GetPlayerInfo());
            return;
        }
        ...
        if (reforgeItem.ItemReforgeRecId != 0)
        {
            ...
            {
                TC_LOG_DEBUG("network", "HandleReforgeItem: {} tried to reforge an item with a non-existing reforge entry! Possible cheater or malformed packet.", GetPlayerInfo());
                return;
            }
