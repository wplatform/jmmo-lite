...
public class MiscHandler {
    ...
    void HandleWhoOpcode(WorldPackets::Who::WhoRequestPkt& whoRequest)
    {
        ...
        TC_LOG_DEBUG("network", "HandleWhoOpcode: MinLevel: {}, MaxLevel: {}, Name: {} (VirtualRealmName: {}), Guild: {} (GuildVirtualRealmName: {}), RaceFilter: {}, ClassFilter: {}, Areas: {}, Words: {}.",
        ...
        {
            TC_LOG_DEBUG("network", "HandleWhoOpcode: Word: {}", request.Words[i].Word);
    ...
    void HandleSetActionBarToggles(WorldPackets::Character::SetActionBarToggles& packet)
    {
        ...
        {
            if (packet.Mask != 0)
                TC_LOG_ERROR("network", "HandleSetActionBarToggles in not logged state with value: {}, ignored", uint32(packet.Mask));
            return;
        }
    ...
    void HandleSetDungeonDifficultyOpcode(WorldPackets::Misc::SetDungeonDifficulty& setDungeonDifficulty)
    {
        ...
        if (!difficultyEntry)
        {
            TC_LOG_DEBUG("network", "HandleSetDungeonDifficultyOpcode: {} sent an invalid instance mode {}!",
        ...
        {
            TC_LOG_DEBUG("network", "HandleSetDungeonDifficultyOpcode: {} sent an non-dungeon instance mode {}!",
        ...
        {
            TC_LOG_DEBUG("network", "HandleSetDungeonDifficultyOpcode: player {} sent unselectable instance mode {}!",
                    _player->GetGUID().ToString(), difficultyEntry->ID);
            return;
        }
        ...
        if (map && map->Instanceable())
        {
            TC_LOG_DEBUG("network", "HandleSetDungeonDifficultyOpcode: player (Name: {}, {}) tried to reset the instance while player is inside!",
    ...
    void HandleSetRaidDifficultyOpcode(WorldPackets::Misc::SetRaidDifficulty& setRaidDifficulty)
    {
        ...
        {
            TC_LOG_DEBUG("network", "HandleSetDungeonDifficultyOpcode: {} sent not matching legacy difficulty {}!",
                    _player->GetGUID().ToString(), difficultyEntry->ID);
            return;
        }
        ...
        if (map && map->Instanceable())
        {
            TC_LOG_DEBUG("network", "HandleSetRaidDifficultyOpcode: player (Name: {}, {}) tried to reset the instance while player is inside!",
                    _player->GetName(), _player->GetGUID().ToString());
            return;
        }
