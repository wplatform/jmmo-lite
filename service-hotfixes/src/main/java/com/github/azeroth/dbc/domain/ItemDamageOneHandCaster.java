...
@Table(name = "item_damage_one_hand_caster")
@Db2DataBind(name = "ItemDamageOneHandCaster.db2", layoutHash = 0xC2186F95, fields = {
...
public class ItemDamageOneHandCaster implements DbcEntity {
    @Id
